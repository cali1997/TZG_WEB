...
export function ProfessionalBackground() {
  ...
  useEffect(() => {
    ...
    function animate() {
      ...
      particles.forEach((particle) => {
        ...
        ctx.fillStyle = `rgba(148, 163, 184, ${particle.opacity})`; // slate-400 with opacity
        ctx.fill();
      });
  ...
  return (
    <>
      ...
      <div className="fixed inset-0 -z-10 bg-gradient-to-br from-slate-900/90 via-slate-800/80 to-slate-700/90" />
    </>
  );
}